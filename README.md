This simple mod removes a random, configurable amount of reinforcement from blocks that are damaged by bombs. Should the bombs damage value exceed the reinforcement level of the block, the block gets destroyed.
